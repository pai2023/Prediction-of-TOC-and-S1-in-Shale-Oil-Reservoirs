...
unlabeled_file = r"C:\Users\User\Desktop\test\calculated_curves\Batch normalization.xlsx"
...
# 3. Define the RNN model structure
...
try:
    ...
    model.load_state_dict(torch.load(r"D:\Result\TOC\RNN\rnn_model-all-TOC.pth"))
    model.eval()
...
try:
    output_path = 'RNN_unlabeled_predictions.xlsx'

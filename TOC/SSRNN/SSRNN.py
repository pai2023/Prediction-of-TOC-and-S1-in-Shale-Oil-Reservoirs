...
file_path = r"C:\Users\User\Desktop\test\calculated_curves\training_and_validation_data.xlsx"
...
plt.xlabel(r'$\mathrm{TOC}_{\mathrm{mea}}$(%)', fontsize=16)
plt.ylabel(r'$\mathrm{TOC}_{\mathrm{RNN}}$(%)', fontsize=16)

...
model.load_state_dict(torch.load('best_overall_model-TOC.pth'))
model.eval()

# **4️⃣ Read new data**
new_data = pd.read_excel(r"C:\Users\User\Desktop\test\calculated_curves\training_and_validation_data.xlsx", sheet_name="111")
...
df_predictions.to_excel(r"C:\Users\User\Desktop\test\predictions-1.xlsx", index=False)

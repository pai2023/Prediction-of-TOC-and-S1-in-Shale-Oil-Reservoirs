...
models = {
    'RNN': r"D:\Result\TOC\RNN\optimized_data.xlsx",
    'SSRNN': r"D:\Result\TOC\SSRNN\optimized_data.xlsx",
    'CNN': r"D:\Result\TOC\CNN\optimized_data.xlsx",
    'SCARNet': r"D:\Result\TOC\SCARNrt\optimized_data.xlsx"
}
...
for idx, (model_name, file_path) in enumerate(models.items()):
    ...
    ax_bot.set_xlabel("TOC (%)", fontname='Times New Roman')
    if idx == 0:
...
plt.savefig("TOC_Comparison_FinalFineTuned-1.png", dpi=600, bbox_inches='tight')
plt.show()
